<footer>
      <div class="container">
            ...
            <ul class="footer-link">
                  <li class="footer-link__group">
                        ...
                        <ul class="footer-link__sub" id="footer-sub-laptop-repair" inert aria-hidden="true">
                              ...
                              <li><a href="#">Laptop Keyboard Replacement</a></li>
                              <li><a href="#">Laptop Hard Drive Replacement</a></li>
                              <li><a href="#">Laptop Motherboard Repair</a></li>
                              <li><a href="#">Laptop Hinge Repair</a></li>
                              <li><a href="#">Data Recovery</a></li>
                              <li><a href="#">Chromebook Repair</a></li>
                        </ul>
                  </li>
                  <li class="footer-link__group">
                        ...
                        <ul class="footer-link__sub" id="footer-sub-macbook-repair" inert aria-hidden="true">
                              ...
                              <li><a href="#">Macbook Logic Board Repair</a></li>
                              <li><a href="#">Macbook Water Damage</a></li>
                        </ul>
                  </li>
                  <li class="footer-link__group">
                  ...
                  <li class="footer-link__group">
                        ...
                        <ul class="footer-link__sub" id="footer-sub-macbook-air-repair" inert aria-hidden="true">
                              ...
                              <li><a href="#">Macbook Air logic board Repair</a></li>
                              <li><a href="#">Macbook Air Trackpad</a></li>
                              <li><a href="#">Macbook Air Hard Drive Repair</a></li>
                              <li><a href="#">Macbook Air Water damage</a></li>
                        </ul>
                  </li>
                  <li class="footer-link__group">
                        ...
                        <ul class="footer-link__sub" id="footer-sub-macbook-pro-repair" inert aria-hidden="true">
                              ...
                              <li><a href="#">MacBook Pro Water Damage Repair</a></li>
                              <li><a href="#">MacBook Pro Screen Repair</a></li>
                              <li><a href="#">MacBook Pro Keyboard Repair</a></li>
                              <li><a href="#">MacBook Pro Hard Drive Repair</a></li>
                        </ul>
                  </li>
                  <li class="footer-link__group">
                        ...
                        <ul class="footer-link__sub" id="footer-sub-phones-repair" inert aria-hidden="true">
                              ...
                              <li><a href="#">iPhone 12 Repair</a></li>
                              <li><a href="#">iPhone 12 Pro Max Repair</a></li>
                              <li><a href="#">iPhone SE (2nd Gen) Repair</a></li>
                              ...
                              <li><a href="#">Samsung Phone Repair</a></li>
                              <li><a href="#">Google Pixel</a></li>
                              <li><a href="#">Motorola</a></li>
                              <li><a href="#">LG</a></li>
                              <li><a href="#">HTC OnePlus</a></li>
                        </ul>
                  </li>
                  <li class="footer-link__group">
                  ...
                  <li class="footer-link__group">
                        ...
                        <ul class="footer-link__sub" id="footer-sub-other-devices" inert aria-hidden="true">
                              ...
                              <li><a href="#">Computer Server Repair</a></li>
                              <li><a href="#">Projector Repair</a></li>
                              <li><a href="#">Game Console Repair</a></li>
                              <li><a href="#">Medical Equipment Repair</a></li>
                              <li><a href="#">Professional IT Services</a></li>
                              <li><a href="#">Remote IT Support</a></li>
                              <li><a href="#">Virus Removal Service</a></li>
                              <li><a href="#">Data transfer Service</a></li>
                              <li><a href="#">SSD Repair</a></li>
                              <li><a href="#">SSD data Recovery</a></li>
                              <li><a href="#">Other Devices Repair</a></li>
                        </ul>
                  </li>
                  <li class="footer-link__group">
                        ...
                        <ul class="footer-link__sub" id="footer-sub-important-links" inert aria-hidden="true">
                              ...
                              <li><a href="#">Mail in Service</a></li>
            ...
            <div class="bottom-footer">
                  <div>
                        <h6 class="mb-2">Visit & Contact Us </h6>
                        <address>169 South St, Morristown, NJ 07960, United States <br>
                              <a href="tel:+19735530794"></a>Phone: +1 973-553-0794</a>
                        </address>
                  </div>
                  <div>
                        <h6 class="mb-2">Working Hours </h6>
                        <p class="mb-0">Monday - Friday: 10 AM – 7 PM</p>
                        <p class="mb-0">Saturday: 12 PM – 6 PM</p>
            ...
            <div class="copyright">
                  <p class="mb-0">© <script>
                        ...
                        </script> LaptopMD+. Operated by Jersey Laptop Repair LLC.</p>
